...
#
#   .github/scripts/changelog-section.sh 0.2.0 [path/to/CHANGELOG.md]
#   .github/scripts/changelog-section.sh v0.2.0
#
# The section is everything between `## [0.2.0] - <date>` and the next `## `
